...
set Library     "hls"
set IPName      "streamToData"
set Version     "1.0"
set DisplayName "Streamtodata"
set Revision    "2113738414"
...
set xo_kernel_name "streamToData"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/github/hdl-master/streamToData/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/github/hdl-master/streamToData/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {streamToData_regslice_both
...
set kernel_xo ""
set detect_deadlock_json "streamToData_message_dict.json"

## Variables
set Top "streamToData"
set TopNoPrefix "streamToData"
...
set Interfaces {
    ap_clk {
        ...
        buses "IN1024OUT8192 IN2048OUT8192 IN4096OUT8192 IN8192OUT65536 IN16384OUT65536 IN32768OUT65536 IN65536OUT262144 IN131072OUT262144 IN262144OUT262144"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 29.802 machine 64 combinational 0 latency 0 II x}
