...
set Library     "hls"
set IPName      "tacho_control"
set Version     "1.1"
set DisplayName "tacho_control_1.1.5"
set Revision    "5"
set Description "tacho_control"
set Device      "zynq"
set AutoFamily  ""
...
set xo_kernel_name "tacho_control"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/github/hdl-master/tacho4/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/github/hdl-master/tacho4/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {tacho_control_control_s_axi
tacho_control
}
set kernel_xo ""
set detect_deadlock_json "tacho_control_message_dict.json"

## Variables
set Top "tacho_control"
set TopNoPrefix "tacho_control"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 in_data_i W 0x0 "Data signal of in_data_i" {{0 32 in_data_i W 0 "Bit 31 to 0 of in_data_i"}}} {0x18 in_data_o R 0x0 "Data signal of in_data_o" {{0 32 in_data_o R 0 "Bit 31 to 0 of in_data_o"}}} {0x1c in_data_o_ctrl R 0x0 "Control signal of in_data_o" {{0 1 in_data_o_ap_vld R 0 "Control signal in_data_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
