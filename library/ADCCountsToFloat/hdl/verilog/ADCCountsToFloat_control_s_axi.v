...
//------------------------Parameter----------------------
localparam
    ADDR_ICURRENTRANGE_DATA_0  = 7'h10,
    ADDR_ICURRENTRANGE_CTRL    = 7'h14,
    ADDR_RESET_DATA_0          = 7'h18,
    ADDR_RESET_CTRL            = 7'h1c,
    ADDR_IOVERLOADCOUNT_DATA_0 = 7'h60,
    ADDR_IOVERLOADCOUNT_CTRL   = 7'h64,
    ADDR_OLVALID_DATA_0        = 7'h70,
    ADDR_OLVALID_CTRL          = 7'h74,
    ADDR_CAL_STEP_BASE         = 7'h20,
    ADDR_CAL_STEP_HIGH         = 7'h3f,
    ADDR_CAL_OFFSET_BASE       = 7'h40,
    ADDR_CAL_OFFSET_HIGH       = 7'h5f,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
