...
module axi_ad5766 #( 
  ...
  always @(posedge spi_clk) begin
    if (spi_resetn == 1'b0) begin
      ...
      if (spi_active == 1'b0) begin
        if ((dac_trigger == 1'b1 && spi_enable_s == 1'b1)) begin  
  //        sdo_mem <= dma_data[23:0];        
          spi_active <= 1'b1;
        end
  ...
  always @(posedge dma_clk) begin
    ...
    if (dma_xfer_req == 1'b0) begin
      ...
      if ((trigger == 1'b1) && doDMAPulse == 1'b0 && (dma_enable == 1'b1) && (spi_enable_s == 1'b1)) begin
        dma_valid <= 1'b1;
        doDMAPulse <= 1'b1;
      end
