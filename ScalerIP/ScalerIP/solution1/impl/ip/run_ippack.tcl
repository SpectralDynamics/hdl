...
## IP Info
set Vendor      "SpectralDynamics"
set Library     "hls"
set IPName      "DriveScale"
set Version     "1.4"
set DisplayName "Drivescale"
set Revision    "2114394018"
...
set xo_kernel_name "DriveScale"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/github/hdl-master/ScalerIP/ScalerIP/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/github/hdl-master/ScalerIP/ScalerIP/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {DriveScale_fmul_32ns_32ns_32_2_max_dsp_1
...
set kernel_xo ""
set detect_deadlock_json "DriveScale_message_dict.json"

## Variables
set Top "DriveScale"
set TopNoPrefix "DriveScale"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 ScaleValue W 0x0 "Data signal of ScaleValue" {{0 32 ScaleValue W 0 "Bit 31 to 0 of ScaleValue"}}} {0x18 ZeroCross W 0x0 "Data signal of ZeroCross" {{0 32 ZeroCross W 0 "Bit 31 to 0 of ZeroCross"}}} {0x50 samp_index W 0x0 "Data signal of samp_index" {{0 32 samp_index W 0 "Bit 31 to 0 of samp_index"}}} {0x58 iCurrentFilter W 0x0 "Data signal of iCurrentFilter" {{0 32 iCurrentFilter W 0 "Bit 31 to 0 of iCurrentFilter"}}} {0x60 fClipValue W 0x0 "Data signal of fClipValue" {{0 32 fClipValue W 0 "Bit 31 to 0 of fClipValue"}}}}
        memories "calibratedStep {base_address 32 range 16} calibratedOffset {base_address 48 range 16} OffsetCounts {base_address 64 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_control IN1024OUT8192 IN2048OUT8192 IN4096OUT8192 IN8192OUT65536 IN16384OUT65536 IN32768OUT65536 IN65536OUT262144 IN131072OUT262144 IN262144OUT262144"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 29.802 machine 64 combinational 0 latency 19 II x}
