...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name tacho_quant_uitofp_32ns_32_6_no_dsp_1_ip
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Uint32 \
                          ...
                          CONFIG.component_name tacho_quant_uitofp_32ns_32_6_no_dsp_1_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips tacho_quant_uitofp_32ns_32_6_no_dsp_1_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files tacho_quant_uitofp_32ns_32_6_no_dsp_1_ip.xci]
generate_target {synthesis simulation} [get_files tacho_quant_uitofp_32ns_32_6_no_dsp_1_ip.xci]
