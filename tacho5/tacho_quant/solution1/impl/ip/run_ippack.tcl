...
set Library     "hls"
set IPName      "tacho_quant"
set Version     "1.0"
set DisplayName "Tacho_quant"
set Revision    "2114356458"
...
set xo_kernel_name "tacho_quant"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/github/hdl-master/tacho5/tacho_quant/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/github/hdl-master/tacho5/tacho_quant/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {tacho_quant_fmul_32ns_32ns_32_4_max_dsp_1
...
set kernel_xo ""
set detect_deadlock_json "tacho_quant_message_dict.json"

## Variables
set Top "tacho_quant"
set TopNoPrefix "tacho_quant"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 out_data R 0x0 "Data signal of out_data" {{0 32 out_data R 0 "Bit 31 to 0 of out_data"}}} {0x14 out_data_ctrl R 0x0 "Control signal of out_data" {{0 1 out_data_ap_vld R 0 "Control signal out_data_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
