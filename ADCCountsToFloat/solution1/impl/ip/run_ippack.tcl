...
set Library     "hls"
set IPName      "ADCCountsToFloat"
set Version     "1.3"
set DisplayName "Adccountstofloat"
set Revision    "2114388251"
...
set xo_kernel_name "ADCCountsToFloat"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/github/hdl-master/ADCCountsToFloat/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/github/hdl-master/ADCCountsToFloat/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {ADCCountsToFloat_fsub_32ns_32ns_32_3_full_dsp_1
...
set kernel_xo ""
set detect_deadlock_json "ADCCountsToFloat_message_dict.json"

## Variables
set Top "ADCCountsToFloat"
set TopNoPrefix "ADCCountsToFloat"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 iCurrentRange W 0x0 "Data signal of iCurrentRange" {{0 32 iCurrentRange W 0 "Bit 31 to 0 of iCurrentRange"}}} {0x18 reset W 0x0 "Data signal of reset" {{0 32 reset W 0 "Bit 31 to 0 of reset"}}} {0x60 iOverloadCount R 0x0 "Data signal of iOverloadCount" {{0 32 iOverloadCount R 0 "Bit 31 to 0 of iOverloadCount"}}} {0x64 iOverloadCount_ctrl R 0x0 "Control signal of iOverloadCount" {{0 1 iOverloadCount_ap_vld R 0 "Control signal iOverloadCount_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 OLValid R 0x0 "Data signal of OLValid" {{0 32 OLValid R 0 "Bit 31 to 0 of OLValid"}}} {0x74 OLValid_ctrl R 0x0 "Control signal of OLValid" {{0 1 OLValid_ap_vld R 0 "Control signal OLValid_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 pointOffset W 0x0 "Data signal of pointOffset" {{0 32 pointOffset W 0 "Bit 31 to 0 of pointOffset"}}} {0x88 gainChanged R 0x0 "Data signal of gainChanged" {{0 32 gainChanged R 0 "Bit 31 to 0 of gainChanged"}}} {0x8c gainChanged_ctrl R 0x0 "Control signal of gainChanged" {{0 1 gainChanged_ap_vld R 0 "Control signal gainChanged_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 status R 0x0 "Data signal of status" {{0 32 status R 0 "Bit 31 to 0 of status"}}} {0x9c status_ctrl R 0x0 "Control signal of status" {{0 1 status_ap_vld R 0 "Control signal status_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "cal_step {base_address 32 range 32} cal_offset {base_address 64 range 32}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 29.802 machine 64 combinational 0 latency 10 II x}
