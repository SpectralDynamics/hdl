...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 bufStart W 0x0 "Data signal of bufStart" {{0 32 bufStart W 0 "Bit 31 to 0 of bufStart"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 30.303 machine 64 combinational 0 latency 1 II x}
