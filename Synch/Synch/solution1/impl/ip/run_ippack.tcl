...
set IPName      "Synch"
set Version     "1.1"
set DisplayName "Synch"
set Revision    "2114553989"
...
set xo_kernel_name "Synch"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/github/hdl-master/Synch/Synch/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/github/hdl-master/Synch/Synch/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {Synch_control_s_axi
Synch
}
set kernel_xo ""
set detect_deadlock_json "Synch_message_dict.json"

## Variables
set Top "Synch"
set TopNoPrefix "Synch"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 bufStart W 0x0 "Data signal of bufStart" {{0 32 bufStart W 0 "Bit 31 to 0 of bufStart"}}} {0x18 bSpuriousSynch_i W 0x0 "Data signal of bSpuriousSynch_i" {{0 1 bSpuriousSynch_i W 0 "Bit 0 to 0 of bSpuriousSynch_i"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 bSpuriousSynch_o R 0x0 "Data signal of bSpuriousSynch_o" {{0 1 bSpuriousSynch_o R 0 "Bit 0 to 0 of bSpuriousSynch_o"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x24 bSpuriousSynch_o_ctrl R 0x0 "Control signal of bSpuriousSynch_o" {{0 1 bSpuriousSynch_o_ap_vld R 0 "Control signal bSpuriousSynch_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 bRunningAcq W 0x0 "Data signal of bRunningAcq" {{0 1 bRunningAcq W 0 "Bit 0 to 0 of bRunningAcq"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 30.303 machine 64 combinational 0 latency 3 II x}
